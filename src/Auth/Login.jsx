...
import { loginInput } from "../Constant/websiteContent";
import FormInput from "../Utils/FormInput";
import {useLayoutEffect, useMemo, useState } from "react";
import { Button, ButtonToolbar } from "rsuite";
import { fetchRequest, getCookie, setCookie } from "../Constant/ReqHelper";
...
export default function Login() {
  ...
  const [isLoggedIn, setIsLoggedIn] = useState(getCookie("userId") || false);
          ...
          <form onSubmit={handleSubmit} method="POST" id="register-form">
            ...
            {forgotPassword && (
              <p className="mt block">
                ...
                <Link
                  to={"/forgot-password"}
                  className="t-primary link navLinks"
                >
                  Click here
                </Link>{" "}
              </p>
